...
export default function ContactUsButton() {
  ...
  return (
    <Fragment>
      ...
      >
        <svg style={{marginRight: "15px"}} width="20" height="17" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Box sx={style}>
          ...
          >
            <Grid2 container alignItems={"center"} justifyContent="space-between">
              ...
              <IconButton disableRipple aria-label="close" onClick={handleClose} sx={{padding: 0}}>
